// Fortune Jumble with CALLBACKS and function arrows
...
const getFortune = (randoming) => {

    const place = randoming(places);
    const job = randoming(jobs);
...
const randomElementPicker = (array) => {
...
console.log(getFortune(randomElementPicker));