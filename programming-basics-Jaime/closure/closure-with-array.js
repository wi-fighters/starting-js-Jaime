function mathematic() { // this is my 'mathematic' function declaration
    ...
    function substractOne() { // the function substractOne() is going to substract '1' to the current value of 'number' and return it
        number -= 1;
        return number;
    }

    let options = [addOne, substractOne]; // the variable 'operation' has two function expressions inside its array
...
console.log(operation[0]()); // we are choosing 'addOne', which is contained in the index '0' of the array 'options', and we are running it. The value of 'substractOne' is the current value of 'number' + '1'. In this moment it will be '1'.
...
console.log(operation[1]()); // we are choosing 'substractOne', which is contained in the index '1' of the array 'options', and we are running it. The value of 'substractOne' in is the current value of 'number' - '1'. Since the value was '1' before this call, now it's going to be '0'.
